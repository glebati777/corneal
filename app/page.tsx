...
import {
  ...
  HeartPulse, X, Sparkles, Gauge, BrainCircuit, Filter
} from "lucide-react";
import {
...
const starterPatients: Patient[] = [
  ...
  { id:"PT-003", fullName:"Сидоров Д.В.", age:58, sex:"М", graftType:"repeat", surgeryType:"DALK", neovascularization:"moderate", priorInflammation:"yes", rejectionHistory:"no", il6:10, tnf:6, vegf:61, tgfb:35, notes:"Промежуточная оценка иммунологических маркеров.", lastVisit:"2026-03-08" },
  { id:"PT-004", fullName:"Соколова Е.В.", age:39, sex:"Ж", graftType:"primary", surgeryType:"DSAEK", neovascularization:"moderate", priorInflammation:"no", rejectionHistory:"no", il6:7, tnf:4, vegf:40, tgfb:26, notes:"Наблюдение после эндотелиальной кератопластики.", lastVisit:"2026-03-11" }
];
const emptyPatient: Patient = {
  ...
  il6:"", tnf:"", vegf:"", tgfb:"", notes:"", lastVisit:new Date().toISOString().slice(0,10)
};
const trendData = [
      ...
      <div className="container" style={{maxWidth:1240,minHeight:"calc(100vh - 48px)",alignItems:"center"}}>
        <div className="grid g2">
          ...
          <div className="hero">
            ...
            <h1 className="heroTitle">Corneal Risk Platform v3</h1>
            <div className="heroText">Полноценная демонстрационная платформа с registry пациентов, dashboard, оценкой риска и аналитикой.</div>
            <div className="metricRow">
              <div className="metric"><div className="muted small">Patient Registry</div><div className="metricValue">4</div></div>
              <div className="metric"><div className="muted small">Risk Analytics</div><div className="metricValue">Live</div></div>
              <div className="metric"><div className="muted small">Clinical Markers</div><div className="metricValue">4</div></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="page">
      <aside className="sidebar">
        ...
        <div className="profile">
          ...
          <div className="tiny" style={{marginTop:12}}>v3: dashboard, registry, analytics, risk model.</div>
        </div>
      </aside>
        ...
        <div className="container">
          <div className="hero">
            <div className="heroGrid">
              <div>
                ...
                <h1 className="heroTitle">Полноценная платформа оценки риска трансплантации роговицы</h1>
                <div className="heroText">Версия v3 объединяет дашборд, реестр пациентов, карточку риска и аналитические панели в одном современном медицинском интерфейсе.</div>
              ...
              <div className="grid">
                ...
                <StatCard title="Высокий риск" value={stats.high} caption="Риск ≥ 65%" icon={ShieldAlert}/>
                <StatCard title="Средний риск" value={`${stats.avg}%`} caption="По всей выборке" icon={BrainCircuit}/>
              </div>
            </div>
          </div>
          ...
          {page==="dashboard" && selected && selectedRisk && (
            <div className="grid">
              <div className="grid g4">
                <StatCard title="Всего пациентов" value={stats.total} caption="Активные записи" icon={Database}/>
                <StatCard title="Высокий риск" value={stats.high} caption="Критическая группа" icon={ShieldAlert}/>
                <StatCard title="Умеренный риск" value={stats.moderate} caption="Требует контроля" icon={Gauge}/>
                <StatCard title="Средний риск" value={`${stats.avg}%`} caption="Средний по базе" icon={BarChart3}/>
              </div>

              <div className="grid g3">
                <div className="card" style={{gridColumn:"span 2"}}>
                  <h2>Центральная клиническая карточка</h2>
                  <div className="muted small">Текущий пациент и ключевые клинические показатели</div>
                    ...
                    <div className="grid">
                      <div className="panel">
                        <div style={{display:"flex",justifyContent:"space-between",gap:12}}>
                          <div>
                            ...
                            <div style={{fontSize:26,fontWeight:800,marginTop:6,color:"#fff"}}>{selected.fullName}</div>
                      ...
                      <div className="metricRow">
                        <div className="metric">
                          <div className="muted small">Тип трансплантации</div>
                          <div className="metricValue">{labelize(selected.graftType,{primary:"Первичная",repeat:"Повторная"})}</div>
                        </div>
                        <div className="metric">
                          <div className="muted small">Вид операции</div>
                          <div className="metricValue">{selected.surgeryType}</div>
                        </div>
                        <div className="metric">
                          <div className="muted small">Неоваскуляризация</div>
                          <div className="metricValue">{labelize(selected.neovascularization,{none:"Нет",moderate:"Умеренная",severe:"Выраженная"})}</div>
                        </div>
                      </div>

                      <div className="card" style={{padding:18}}>
                        <div className="muted small">Клинический summary</div>
                        <div style={{marginTop:8,color:"#fff"}}>{selected.notes || "Заметки отсутствуют."}</div>
                      </div>
                    </div>

                    <div className="grid">
                      <div className="panel">
                        <div style={{display:"flex",justifyContent:"space-between",marginBottom:8}} className="small">
                          <span>Оценка риска</span><strong>{selectedRisk.risk}%</strong>
                        </div>
                      ...
                      <div className="metricRow">
                        <div className="metric"><div className="muted small">IL-6</div><div className="metricValue">{selected.il6}</div></div>
                        <div className="metric"><div className="muted small">TNF-α</div><div className="metricValue">{selected.tnf}</div></div>
                        <div className="metric"><div className="muted small">VEGF</div><div className="metricValue">{selected.vegf}</div></div>
                      </div>
                      <div className="card" style={{padding:18}}>
                ...
                <div className="card">
                  ...
                  <div className="muted small">Инструменты для демонстрации системы</div>
                  <div className="grid" style={{marginTop:18}}>
                    ...
                    <button className="btn outline" onClick={()=>setPage("patients")}><UserRound size={16}/>Открыть базу пациентов</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          {page==="patients" && selected && selectedRisk && (
            <div className="grid g3">
              <div className="card">
                <h2>Пациенты</h2>
                <div className="muted small">Поиск, фильтрация и сортировка</div>
                ...
                <div className="list" style={{marginTop:18}}>
                  {filteredPatients.map(p=>{
                    ...
                    return (
                      <button key={p.id} className={`patientBtn ${selectedId===p.id ? "active" : ""}`} onClick={()=>setSelectedId(p.id)}>
                        <div style={{display:"flex",justifyContent:"space-between",gap:10}}>
                          <div>
                            <div style={{fontWeight:700}}>{p.fullName}</div>
                            <div className="muted small">{p.id} · {p.surgeryType} · визит {p.lastVisit}</div>
                          </div>
                          <RiskBadge risk={risk.risk}/>
                        </div>
                        <div className="muted small" style={{marginTop:8}}>{p.notes}</div>
                      </button>
                    );
                  })}
                </div>
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                <div style={{display:"flex",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
                  <div>
                    ...
                    <div className="muted small">Подробные данные и интерпретация риска</div>
                  </div>
                  <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                ...
                {tab==="summary" && (
                  <div className="grid g3" style={{marginTop:18}}>
                    {[
                      ...
                      ["Вид операции", labelize(selected.surgeryType,{PKP:"PKP — сквозная",DALK:"DALK — глубокая передняя послойная",DSAEK:"DSAEK — автоматизированная эндотелиальная",DMEK:"DMEK — мембрана Десцемета"})],
                      ...
                      <div key={String(l)} className="panel">
                        ...
                        <div style={{marginTop:6,fontWeight:700,color:"#fff"}}>{v}</div>
                      </div>
                    ))}
                    <div className="card" style={{gridColumn:"1 / -1",padding:18}}>
                      <div className="muted small">Заметки врача</div>
                      <div style={{marginTop:8,color:"#fff"}}>{selected.notes || "—"}</div>
                    </div>
                  </div>
                )}

                {tab==="markers" && (
                  <div className="metricRow" style={{marginTop:18}}>
                    {[["IL-6",selected.il6],["TNF-α",selected.tnf],["VEGF",selected.vegf],["TGF-β",selected.tgfb]].map(([l,v])=>(
                      <div key={String(l)} className="metric">
                        <div className="muted small">{l}</div>
                ...
                {tab==="recommendations" && (
                  <div className="grid" style={{marginTop:18}}>
                    <div className="panel">
                      <div className="muted small">Риск</div>
                      <div style={{fontSize:34,fontWeight:800,marginTop:6,color:"#fff"}}>{selectedRisk.risk}%</div>
            ...
            <div className="grid">
              <div className="grid g2">
                <div className="card">
                  ...
                  <div className="muted small">Сколько пациентов находится в каждой группе</div>
                ...
                <div className="card">
                  ...
                  <div className="muted small">Средние показатели по всей базе</div>
                  <div style={{height:320,marginTop:10}}>
                    <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="grid g2">
                <div className="card">
                  ...
                  <div className="muted small">Состав клинической базы по типам вмешательств</div>
                  <div style={{height:320,marginTop:10}}>
                    <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="card">
                  ...
                  <div className="muted small">Пример клинического временного ряда</div>
                  <div style={{height:320,marginTop:10}}>
                    <ResponsiveContainer width="100%" height="100%">
          ...
          {page==="model" && (
            <div className="grid g3">
              <div className="card" style={{gridColumn:"span 2"}}>
                <h2>Концепция модели риска</h2>
                <div className="muted small">Логика того, как система может развиваться до полноценного ML-модуля</div>
                <div className="grid" style={{marginTop:18}}>
                  {[
                    ["Входные признаки","Тип трансплантации, вид операции, неоваскуляризация, воспаление, отторжение в анамнезе, IL-6, TNF-α, VEGF и TGF-β."],
                    ["Алгоритмы","Логистическая регрессия, Random Forest, XGBoost, ансамблевые подходы."],
                    ["Выход системы","Вероятность риска, стратификация по группам, текстовые рекомендации и визуальная аналитика."],
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  <div>• Единый clinical dashboard</div>
                  <div>• Пациент-центричный интерфейс</div>
                  <div>• Аналитика и визуализация</div>
                  <div>• Основа для ML-модуля</div>
                  <div>• Готовность к демонстрации</div>
                </div>
              </div>
            </div>
          )}
          ...
          {page==="about" && (
            <div className="grid g2">
              <div className="card">
                <h2>О платформе</h2>
                <div className="grid small muted" style={{marginTop:18}}>
                  <div>Corneal Risk Platform v3 объединяет клинические данные, dashboard, patient registry и аналитику в единой среде.</div>
                  <div>Система подходит для демонстрации как цифровой платформы поддержки принятия решений в офтальмологии.</div>
                  <div>Архитектура уже подготовлена для дальнейшего подключения backend, базы данных и реальной ML-модели.</div>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  <div>• Красивый PDF-отчёт</div>
                  <div>• Авторизация и роли врача</div>
                  <div>• PostgreSQL и backend API</div>
                  <div>• Реальная ML-модель риска</div>
                  <div>• Интеграция с медицинской системой</div>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="modal">
            <div style={{display:"flex",justifyContent:"space-between",gap:12,alignItems:"start"}}>
              <div>
                ...
                <div className="muted small">Заполните клинические параметры для расчёта риска.</div>
              </div>
            ...
            <div className="grid g3" style={{marginTop:20}}>
              ...
              <div><label className="label">Вид операции</label><select className="select" value={form.surgeryType} onChange={e=>setForm({...form,surgeryType:e.target.value})}><option value="PKP">PKP — сквозная</option><option value="DALK">DALK — глубокая передняя послойная</option><option value="DSAEK">DSAEK — автоматизированная эндотелиальная</option><option value="DMEK">DMEK — мембрана Десцемета</option></select></div>
