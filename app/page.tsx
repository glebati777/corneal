...
function exportReportёт(p?:Patient){
  if(!p) return;
        ...
        <div className="container">
          <div className="hero">
            ...
            <div className="heroActions">
              ...
              <button className="btn outline" onClick={()=>exportReportёт(selected)}><Download size={16}/>PDF-отчёт</button>
            </div>
            ...
            <div className="grid g3">
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                {tab==="report" && <div className="reportSheet" style={{marginTop:18}}>
                  ...
                  <div style={{marginTop:16}}><button className="btn" onClick={()=>exportReportёт(selected)}><Download size={16}/>Печать / сохранить PDF</button></div>
                </div>}
              </div>
            </div>
          )}
