      ...
      <main className="main">
        <div className="container">
          <div className="hero heroV3 glass">
            ...
            <div className="heroTopLine"><h1 className="heroTitle">Clinical AI</h1><div className="heroMiniPanel"><div className="muted tiny">Текущий прогноз</div><strong>{ml.probability}%</strong></div></div>
