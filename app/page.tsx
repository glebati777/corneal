      ...
      <main className="main">
        <div className="container">
          <div className="hero heroV3 glass">
            <div className="heroBadge"><HeartPulse size={14} />Corneal Graft Analytics V7</div>
            <div className="heroTopLine"><h1 className="heroTitle">Финальная клиническая версия V7</h1><div className="heroMiniPanel"><div className="muted tiny">Текущий прогноз</div><strong>{ml.probability}%</strong></div></div>
            <div className="heroText">Финальная чистая версия: динамика визитов, крупный график риска, AI-рекомендации, cohort analytics и аккуратная стабильная сетка без наложений.</div>
