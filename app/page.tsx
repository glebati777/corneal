...
const STORAGE_KEY = "corneal_v7_premium";
...
function exportReport(patient?: Patient){
  ...
  a.href = url; a.download = `${patient.id}_report.txt`; a.click(); URL.revokeObjectURL(url);
}
    ...
    <div className="page">
      ...
      <main className="main"><div className="container">
            ...
            <div className="card" style={{gridColumn:"span 2"}}>
              ...
              <div className="grid g2" style={{marginTop:18}}>
                <div className="grid">
                  ...
                  <div className="callout"><div className="muted small">Клинический комментарий</div><div style={{marginTop:8,color:"#fff"}}>{selected.notes || "Дополнительные заметки не указаны."}</div></div>
        ...
        {page==="patients" && selected && selectedRisk && <div className="grid g3">
          <div className="card">
            <h2>Реестр пациентов</h2><div className="muted small">Поиск, фильтрация и сортировка записей</div>
          ...
          <div className="card" style={{gridColumn:"span 2"}}>
            ...
            {tab==="recommendations" && <div className="grid g2" style={{marginTop:18}}>
              ...
              <div className="grid"><div className="callout"><div className="muted small">Рекомендация</div><div style={{marginTop:8,color:"#fff"}}>{selectedRisk.recommendation}</div></div><div className="callout"><div className="muted small">Краткий вывод</div><div style={{marginTop:8,color:"#fff"}}>{selectedSummary}</div></div></div>
            </div>}
        ...
        {page==="analytics" && <div className="grid">
          ...
          <div className="grid g2">
            ...
            <div className="card"><h2>Динамика биомаркеров</h2><div className="muted small">Пример наблюдения во времени</div><div style={{height:320,marginTop:10}}><ResponsiveContainer width="100%" height="100%"><LineChart data={trendData}><CartesianGrid strokeDasharray="3 3" stroke="rgba(148,163,184,.18)" /><XAxis dataKey="date" stroke="#94a3b8" /><YAxis stroke="#94a3b8" /><Tooltip /><Legend /><Line type="monotone" dataKey="IL1" name="IL-1" strokeWidth={2} /><Line type="monotone" dataKey="IL6" name="IL-6" strokeWidth={2} /><Line type="monotone" dataKey="TNFa" name="TNF-α" strokeWidth={2} /><Line type="monotone" dataKey="VEGF" name="VEGF" strokeWidth={2} /><Line type="monotone" dataKey="TGFB" name="TGF-β" strokeWidth={2} /></LineChart></ResponsiveContainer></div></div>
          </div>
        </div>}
        ...
        {page==="methodology" && <div className="grid g3">
          ...
          <div className="card"><h2>Новые улучшения v7</h2><div className="featureList"><div className="featureItem"><WandSparkles size={16} style={{marginRight:8}}/> Улучшенный clinical gauge</div><div className="featureItem"><Activity size={16} style={{marginRight:8}}/> Patient timeline</div><div className="featureItem"><FileText size={16} style={{marginRight:8}}/> Printable report sheet</div></div></div>
        </div>}
        ...
        {page==="about" && <div className="grid g2">
          ...
          <div className="card"><h2>Дальнейшее развитие</h2><div className="grid small muted" style={{marginTop:18}}><div>• Подключение backend и базы данных</div><div>• Экспорт PDF</div><div>• Настройка ролей пользователей</div><div>• Интеграция с клиническими системами</div><div>• Валидация на реальном датасете</div></div></div>
        </div>}
      </div></main>
