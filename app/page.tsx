...
import {
  ...
  AlertTriangle, FileText, Microscope, ShieldCheck, ScanEye, Cpu, Activity
} from "lucide-react";
...
function exportReport(p?:Patient){
  ...
  <html><head><title>Clinical Report</title><style>
    ...
    <div>Structured follow-up summary after corneal transplantation</div>
    <div class="grid">
      ...
      <div class="box"><strong>Risk score</strong><div>${res.risk}% · ${res.level}</div></div>
      <div class="box"><strong>ML rejection forecast</strong><div>${ml.probability}% · ${ml.classLabel}</div></div>
    </div>
...
function ThreeDEye() {
  ...
  return (
    ...
    >
      <div className="eyeGlow" />
      <div className="eyeModel" style={{ transform: `rotateX(${rx}deg) rotateY(${ry}deg)` }}>
        <div className="eyeShell">
          <div className="eyeCornea">
            <div className="iris">
              <div className="pupil" />
      ...
      <div className="eyeCaption">
        <div className="tiny muted">3D eye model</div>
        <strong>Interactive corneal view</strong>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="gaugeWrap">
      <div className={`gaugeShell ${gaugeClass}`}>
        ...
        <div className="gaugeLabels"><span>LOW</span><span>MODERATE</span><span>HIGH</span></div>
      </div>
    </div>
  );
}
      ...
      <div className="container" style={{maxWidth:1240,minHeight:"calc(100vh - 48px)",alignItems:"center"}}>
        <div className="grid g2">
          ...
          <div className="hero">
            ...
            <div className="heroText">Интерфейс для мониторинга пациентов после трансплантации роговицы с акцентом на аккуратный clinical UX, AI-assisted интерпретацию и демонстрацию ML-прогноза.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="page">
      <aside className="sidebar">
        ...
        <div className="userBox"><div style={{fontWeight:700,color:"#fff"}}>Пользователь</div><div style={{marginTop:6}}>{user.email}</div><div className="tiny" style={{marginTop:12}}>Оценка риска и ML-прогноз на этой демо-версии не являются клинически валидированными моделями.</div></div>
      </aside>
      ...
      <main className="main">
        <div className="container">
          <div className="hero">
            ...
            <div className="heroText">Аккуратный clinical dashboard: реестр пациентов, ориентировочная стратификация риска, интерактивная 3D-модель глаза, AI-assisted interpretation и demo ML-forecast отторжения.</div>
            <div className="heroActions">
              <button className="btn outline" onClick={openNew}><Plus size={16}/>Новый пациент</button>
              <button className="btn outline" onClick={()=>exportReport(selected)}><Download size={16}/>PDF report</button>
            </div>
            ...
            <div className="grid g3">
              <div className="card" style={{gridColumn:"span 2"}}>
                <div className="sectionTitle">
                  <div>
                    ...
                    <div className="muted small">Ключевые клинические параметры, ориентировочная оценка риска, ML-прогноз и интерпретация в одной панели</div>
                  </div>
                  <div className="kpiPill"><ShieldCheck size={14}/> Demo prediction only</div>
                </div>
                ...
                <div className="grid g2" style={{marginTop:18}}>
                  <div className="grid">
                    ...
                    <div className={`alertBox ${alertClass}`}>
                      <div style={{display:"flex",alignItems:"center",gap:10,fontWeight:800}}><AlertTriangle size={18}/> Clinical Alert</div>
                    ...
                    <div className="softCard glowBlue">
                      <div className="headerRow">
                        <div>
                          <div className="muted tiny">ML rejection forecast</div>
                      ...
                      <div className="note" style={{marginTop:12}}>Это demo logistic model без клинической валидации. Она показывает, как может выглядеть ML-блок внутри продукта.</div>
                    </div>
                  ...
                  <div className="grid">
                    <div className="panel premiumTopGrid">
                      <div className="premiumGaugeBox">
                        ...
                        <div className="small muted" style={{marginTop:2}}>Risk score</div>
                    ...
                    <div className="grid g2">
                      <div className="card">
                        <div className="muted small">Risk Contributors</div>
                      ...
                      <div className="card">
                        <div className="muted small">Biomarker Heatmap</div>
                        <div className="heatmapGrid">
                          {heatItems.map(([name,value])=>{
                            const s=heatStatus(name,value);
                            return <div key={name} className="heatItem"><div className="heatHeader"><span>{name}</span><span className={`statusDot status-${s}`}></span></div><div className="heatValue">{value}</div><div className="tiny muted">{s==="high"?"High":s==="mid"?"Intermediate":"Low"}</div></div>;
                          })}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="card">
                      <div className="muted small">AI-assisted Risk Explanation</div>
              ...
              <div className="card">
                ...
                <div className="softCard glowGreen" style={{marginTop:16}}>
                  <div className="headerRow">
                    <div>
                      <div className="muted tiny">Vision module</div>
                      <strong>3D eye scene</strong>
                    </div>
                    <ScanEye size={18}/>
                  </div>
                  <div className="small muted" style={{marginTop:8}}>Интерактивная сцена добавляет презентационный эффект и лучше показывает medical-product подачу.</div>
                </div>

                <div className="softCard glowBlue" style={{marginTop:16}}>
                  <div className="headerRow">
                    <div>
                      <div className="muted tiny">Model lab</div>
                      <strong>AI + ML demo blocks</strong>
                    </div>
                    <Activity size={18}/>
                  </div>
                  <div className="small muted" style={{marginTop:8}}>В этой версии показаны демонстрационные блоки прогнозирования. Для реальной модели понадобится клинический датасет и отдельная валидация.</div>
                </div>
              </div>
            </div>
          </>}
            ...
            <div className="grid g3">
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                {tab==="markers" && <div className="grid g2" style={{marginTop:18}}>
                  ...
                  <div className="card"><div className="muted small">3D eye scene</div><div style={{marginTop:12}}><ThreeDEye /></div></div>
                </div>}
                ...
                {tab==="recommendations" && <div className="grid g2" style={{marginTop:18}}>
                  <div className="grid">
                    ...
                    <div className="softCard glowBlue">
                      <div className="headerRow"><div><div className="muted tiny">ML rejection forecast</div><strong>{ml.probability}% · {ml.classLabel}</strong></div><Cpu size={18}/></div>
                      <div className="small muted" style={{marginTop:8}}>Demo logistic model, not clinically validated.</div>
                    </div>
                  </div>
                  <div className="grid">
                ...
                {tab==="report" && <div className="reportSheet" style={{marginTop:18}}>
                  ...
                  <div className="reportMeta">
                    ...
                    <div className="reportBlock"><strong>ML rejection forecast</strong><div>{ml.probability}% · {ml.classLabel}</div></div>
                  </div>
                  <div className="reportBlock" style={{marginTop:14}}><strong>Clinical interpretation</strong><div style={{marginTop:8}}>{explanation(selected)}</div></div>
          ...
          {page==="analytics" && (
            <div className="grid g2">
              ...
              <div className="card">
                <h2>ML / AI блоки</h2>
                <div className="note" style={{marginTop:14}}>AI explanation в этой версии основан на правилах интерпретации признаков, а ML rejection forecast — на демонстрационной логистической модели. Для реального медицинского использования потребуется обучающий клинический датасет, разделение на train/validation/test и внешняя валидация.</div>
              </div>
            </div>
          )}
          ...
          {page==="about" && (
            <div className="grid g2">
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  <div>• Единая central clinical card</div>
                  <div>• 3D eye scene</div>
                  <div>• Heatmap биомаркеров</div>
                  <div>• AI-assisted explanation</div>
                  <div>• Demo ML rejection forecast</div>
