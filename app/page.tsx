...
const STORAGE_KEY = "corneal_v4_premium";
const starterPatients: Patient[] = [
  ...
  { id:"PT-002", fullName:"Петрова А.А.", age:31, sex:"Ж", graftType:"primary", surgeryType:"DMEK", neovascularization:"none", priorInflammation:"no", rejectionHistory:"no", il6:4, tnf:3, vegf:22, tgfb:18, notes:"Спокойное течение послеоперационного периода.", lastVisit:"2026-03-12" },
  { id:"PT-003", fullName:"Сидоров Д.В.", age:58, sex:"М", graftType:"repeat", surgeryType:"DALK", neovascularization:"moderate", priorInflammation:"yes", rejectionHistory:"no", il6:10, tnf:6, vegf:61, tgfb:35, notes:"Нужна промежуточная оценка лабораторных маркеров и клинической динамики.", lastVisit:"2026-03-08" },
  { id:"PT-004", fullName:"Соколова Е.В.", age:39, sex:"Ж", graftType:"primary", surgeryType:"DSAEK", neovascularization:"moderate", priorInflammation:"no", rejectionHistory:"no", il6:7, tnf:4, vegf:40, tgfb:26, notes:"Плановое наблюдение после эндотелиальной кератопластики.", lastVisit:"2026-03-11" }
];
          ...
          <div className="hero">
            ...
            <div className="metricGrid" style={{marginTop:18}}>
              <div className="metric">
                <div className="muted small">Patient Registry</div>
                <div className="metricValue">4</div>
              </div>
              <div className="metric">
                <div className="muted small">Risk Analytics</div>
                <div className="metricValue">Live</div>
              </div>
              <div className="metric">
                <div className="muted small">Clinical Markers</div>
                <div className="metricValue">4</div>
              </div>
            </div>
          </div>
...
export default function Page(){
  ...
  const surgeryChart = ["PKP","DALK","DSAEK","DMEK"].map(name => ({
    name,
    value: patients.filter(p=>p.surgeryType === name).length
  }));
                    ...
                    <div className="grid">
                      <div className="panel">
                        <div style={{display:"flex",justifyContent:"space-between",marginBottom:8}} className="small">
                          <span>Ориентировочная оценка риска</span>
                          <strong>{selectedRisk.risk}%</strong>
                        </div>
                      ...
                      <div className="metricGrid">
                        <div className="metric">
                          <div className="muted small">IL-6</div>
                          <div className="metricValue">{selected.il6}</div>
                        </div>
                        <div className="metric">
                          <div className="muted small">TNF-α</div>
                          <div className="metricValue">{selected.tnf}</div>
                        </div>
                        <div className="metric">
                          <div className="muted small">VEGF</div>
                          <div className="metricValue">{selected.vegf}</div>
                        </div>
                      </div>

                      <div className="callout">
                        <div className="muted small">Клиническая интерпретация</div>
          ...
          {page==="patients" && selected && selectedRisk && (
            <div className="grid g3">
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                {tab==="summary" && (
                  <div className="grid g3" style={{marginTop:18}}>
                    ...
                    <div className="callout" style={{gridColumn:"1 / -1"}}>
                      <div className="muted small">Комментарий врача</div>
                ...
                {tab==="markers" && (
                  <div className="metricGrid" style={{marginTop:18}}>
                    {[["IL-6",selected.il6],["TNF-α",selected.tnf],["VEGF",selected.vegf],["TGF-β",selected.tgfb]].map(([label,value])=>(
                ...
                {tab==="recommendations" && (
                  <div className="grid" style={{marginTop:18}}>
                    <div className="panel">
                      ...
                      <div style={{fontSize:34,fontWeight:850,marginTop:6,color:"#fff"}}>{selectedRisk.risk}%</div>
            ...
            <div className="grid g3">
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                <div className="grid" style={{marginTop:18}}>
                  {[
                    ...
                    ["Входные параметры","Тип трансплантации, вид операции, неоваскуляризация, воспаление в анамнезе, предыдущие эпизоды отторжения и лабораторные маркеры IL-6, TNF-α, VEGF, TGF-β."],
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  <div>• Чёткая структура patient registry</div>
                  <div>• Визуальная стратификация риска</div>
                  <div>• Понятная аналитика по маркерам</div>
                  <div>• Корректные, аккуратные формулировки</div>
                  <div>• Основа для дальнейшего развития</div>
                </div>
              </div>
            </div>
          )}
