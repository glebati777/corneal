  ...
  return (
    <div className={`corneaStage ${tone}`}>
      ...
      <div className="corneaLegend">
        <div className="tiny muted">Наглядная схема</div>
        <strong>Состояние роговичного комплекса</strong>
        <div className="small muted" style={{marginTop:6}}>
          {risk >= 65 ? "Выраженная активность факторов риска и признаков воспаления." : risk >= 35 ? "Желателен более частый контроль." : "Текущая картина соответствует стабильному наблюдению."}
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="page">
      <aside className="sidebar">
        ...
        <div className="userBox"><div style={{fontWeight:700,color:"#fff"}}>Пользователь</div><div style={{marginTop:6}}>{user.email}</div><div className="tiny" style={{marginTop:12}}>Оценка риска и прогноз вероятности отторжения в этой демонстрационной версии не являются клинически валидированными моделями.</div></div>
      </aside>
        ...
        <div className="container">
            ...
            <div className="grid g3">
              <div className="card" style={{gridColumn:"span 2"}}>
                <div className="sectionTitle">
                  <div>
                    ...
                    <div className="muted small">Ключевые клинические параметры, оценка риска, прогноз вероятности отторжения и клиническая интерпретация в одной панели</div>
                  </div>
                  <div className="kpiPill"><ShieldCheck size={14}/> Демонстрационная модель</div>
                </div>
                ...
                <div className="grid g2" style={{marginTop:18}}>
                  <div className="grid">
                    ...
                    <div className="softCard glowBlue">
                      ...
                      <div className="note" style={{marginTop:12}}>Это демонстрационная логистическая модель без клинической валидации. Она показывает, как может выглядеть модуль прогноза внутри цифровой платформы.</div>
                    </div>
              ...
              <div className="card">
                ...
                <div className="grid" style={{marginTop:18}}>
                  ...
                  <button className="btn outline" onClick={()=>exportОтчёт(selected)}><Download size={16}/>Скачать отчёт PDF</button>
          ...
          {page==="patients" && selected && selectedRisk && ml && (
            <div className="grid g3">
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                <div className="headerRow">
                  <div><h2>Карточка пациента</h2><div className="muted small">Структурированные сведения, биомаркеры и интерпретация клинической картины</div></div>
                ...
                {tab==="recommendations" && <div className="grid g2" style={{marginTop:18}}>
                  <div className="grid">
                    ...
                    <div className="softCard glowBlue">
                      <div className="headerRow"><div><div className="muted tiny">Вероятность отторжения</div><strong>{ml.probability}% · {ml.classLabel}</strong></div><Cpu size={18}/></div>
                      <div className="small muted" style={{marginTop:8}}>Демонстрационная логистическая модель без клинической валидации.</div>
                    </div>
                  </div>
                  <div className="grid">
                    <div className="card"><div className="muted small">Автоматическая интерпретация</div><div style={{marginTop:8}}>{explanation(selected)}</div></div>
            ...
            <div className="grid g2">
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  ...
                  <div>• Автоматическая интерпретация</div>
                  <div>• Demo Вероятность отторжения</div>
