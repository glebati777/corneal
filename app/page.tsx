      ...
      <main className="main">
        <div className="container">
          <div className="hero">
            ...
            <div className="heroText">Аккуратная цифровая платформа: реестр пациентов, ориентировочная стратификация риска, автоматическая интерпретация показателей и демонстрационный ML-прогноз вероятности отторжения.</div>
                ...
                <div className="grid g2" style={{marginTop:18}}>
                  ...
                  <div className="grid">
                    <div className="panel premiumTopGrid">
                      ...
                      <div className="softCard glowBlue compactInfoCard"><div className="headerRow"><div><div className="muted tiny">Клинический статус</div><strong>{selectedRisk.level} риск</strong></div><ShieldCheck size={18}/></div><div className="small muted" style={{marginTop:8}}>{selectedRisk.risk >= 65 ? "Требуется усиленный мониторинг и более плотный клинический контроль." : selectedRisk.risk >= 35 ? "Желателен сокращённый интервал повторного наблюдения." : "Картина соответствует стабильному плановому наблюдению."}</div></div>
                    </div>
            ...
            <div className="grid g3">
                    ...
                    return (
                      <button key={patient.id} className={`patientBtn ${selectedId===patient.id ? "active" : ""}`} onClick={()=>setSelectedId(patient.id)}>
                        <div style={{display:"flex",justifyContent:"space-between",gap:10}}>
                          <div><div className="patientName">{patient.fullName}</div><div className="muted small">{patient.id} · {patient.surgeryType} · визит {patient.lastVisit}</div></div>
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                {tab==="summary" && <div className="grid g3" style={{marginTop:18}}>
                  ...
                  <div className="card" style={{gridColumn:"1 / -1"}}><div className="muted small">Клиническая сводка</div><div style={{marginTop:8}}>{explanation(selected)}</div></div>
                </div>}
                ...
                {tab==="markers" && <div className="grid g2" style={{marginTop:18}}>
                  ...
                  <div className="card"><div className="muted small">Схема роговицы</div><div style={{marginTop:12}}><div className="softCard glowBlue compactInfoCard"><div className="headerRow"><div><div className="muted tiny">Клинический статус</div><strong>{selectedRisk.level} риск</strong></div><ShieldCheck size={18}/></div><div className="small muted" style={{marginTop:8}}>{selectedRisk.risk >= 65 ? "Требуется усиленный мониторинг и более плотный клинический контроль." : selectedRisk.risk >= 35 ? "Желателен сокращённый интервал повторного наблюдения." : "Картина соответствует стабильному плановому наблюдению."}</div></div></div></div>
                </div>}
