...
const STORAGE_KEY = "corneal_v5_worldclass";
          ...
          {page==="patients" && selected && selectedRisk && (
            <div className="grid g3">
              ...
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                {tab==="markers" && (
                  <div className="markerGrid" style={{marginTop:18}}>
                    {[
                      ["Интерлейкин-1", selected.il1],
                      ["IL-6", selected.il6],
                      ["TNF-α", selected.tnf],
            ...
            <div className="grid g3">
              <div className="card" style={{gridColumn:"span 2"}}>
                ...
                <div className="grid" style={{marginTop:18}}>
                  {[
                    ...
                    ["Входные параметры","Тип трансплантации, вид операции, неоваскуляризация, воспаление в анамнезе, предыдущие эпизоды отторжения, интерлейкин-1, IL-6, TNF-α, VEGF и TGF-β."],
              ...
              <div className="card">
                ...
                <div className="grid small muted" style={{marginTop:18}}>
                  ...
                  <div>• Аналитика по IL-1 и другим маркерам</div>
                  <div>• Аккуратные клинические формулировки</div>
        ...
        <div className="modalBg">
          <div className="modal">
            ...
            <div className="grid g3" style={{marginTop:20}}>
              ...
              <div><label className="label">Интерлейкин-1</label><input className="input" type="number" value={form.il1} onChange={e=>setForm({...form,il1:e.target.value})} /></div>
