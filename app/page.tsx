      ...
      <main className="main">
        <div className="container">
          <div className="hero heroV3 glass">
            <div className="heroBadge"><HeartPulse size={14} />Corneal Graft Analytics V6</div>
            <div className="heroTopLine"><h1 className="heroTitle">Clinical-grade интерфейс наблюдения V6</h1><div className="heroMiniPanel"><div className="muted tiny">Текущий прогноз</div><strong>{ml.probability}%</strong></div></div>
            <div className="heroText">Исправленная и стабильная версия: динамика визитов, крупный график риска, AI-рекомендации, cohort analytics и аккуратная адаптивная сетка без выхода карточек за границы.</div>
