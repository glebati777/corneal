      ...
      <main className="main">
        <div className="container">
          <div className="hero heroV3 glass">
            <div className="heroBadge"><HeartPulse size={14} />Corneal Graft Analytics V9</div>
            <div className="heroTopLine"><h1 className="heroTitle">Clinical AI version V9</h1><div className="heroMiniPanel"><div className="muted tiny">Текущий прогноз</div><strong>{ml.probability}%</strong></div></div>
            <div className="heroText">Добавлены AI Clinical Report, patient risk stratification и Kaplan–Meier survival curve. Сетка очищена и стабилизирована без наложений.</div>
          ...
          {page === "analytics" && <div className="grid g2">
            ...
            <div className="card glass">
              <h2>AI и ML блоки</h2>
              <div className="note" style={{ marginTop: 14 }}>В версии V9 добавлены AI Clinical Report, patient risk stratification и Kaplan–Meier survival curve. Все клинические и аналитические блоки приведены к более чистому и устойчивому визуальному состоянию.</div>
            </div>
          </div>}
